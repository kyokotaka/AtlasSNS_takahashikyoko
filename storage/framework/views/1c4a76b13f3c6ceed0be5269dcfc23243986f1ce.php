...
<html>
  ...
  <body>
    <header>
        ...
        <div class="icon">
        <img src="<?php echo e(asset('/storage/' . Auth::user()->images)); ?>" alt="aa">
        </div>
    </header>
    <div id="row">
        <div id="container">
...
<?php /**PATH /Users/takahashikyouko/Desktop/AtlasSNS_takahashikyoko/resources/views/layouts/login.blade.php ENDPATH**/ ?>