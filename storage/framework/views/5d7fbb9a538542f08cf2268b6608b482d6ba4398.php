...
<form method="post" action="/search">
  ...
  <div id="search">
    <input type="text" name="keyword"  placeholder="ユーザー名">
      <button type="submit" input type="image" src=""><img src="/images/search.png" class="search_icon"></button>
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/takahashikyouko/Desktop/AtlasSNS_takahashikyoko/resources/views/users/search.blade.php ENDPATH**/ ?>